...
function executeGroq(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return client_1.default(clientOptions)
            ...
            if (err.statusCode === 401) {
                ...
                return client_1.default(noTokenClientOptions).fetch(query, params, { filterResponse: false });
            }
            throw err;
        });
    });
}
exports.executeGroq = executeGroq;
